...
int main(int argc, const char * argv[]) {
    ...
    for(int i = 1; i < 10; i++) {
        fig = std::make_shared<Octagon>((i * i * i + i * i) % 13 + 1);
        list.push_back(fig);
    }
    ...
    std::cout << "7. sort sequential" << std::endl;
    std::cout << "8. sort concurrent" << std::endl;
    ...
    while (menuNum != 0) {
        ...
        switch (menuNum)
        {
            ...
            case 6:
                ...
                break;
            case 7:
                list.sort_sequential();
                break;
            case 8:
                list.sort_concurrent();
                break;
            case 9:
                break;
        }
